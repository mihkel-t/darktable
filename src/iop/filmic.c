...
void gui_init(dt_iop_module_t *self)
{
  ...
  dt_bauhaus_slider_set_format(g->grey_point_source, _("%.2f%%"));
  ...
  dt_bauhaus_slider_set_format(g->latitude_stops, _("%.2f EV"));
  ...
  dt_bauhaus_slider_set_format(g->balance, _("%.2f%%"));
  ...
  dt_bauhaus_slider_set_format(g->global_saturation, _("%.2f%%"));
  ...
  */
  ...
  dt_bauhaus_slider_set_format(g->black_point_target, _("%.2f%%"));
  ...
  dt_bauhaus_slider_set_format(g->grey_point_target, _("%.2f%%"));
  ...
  dt_bauhaus_slider_set_format(g->white_point_target, _("%.2f%%"));
