...
void gui_init(dt_iop_module_t *self)
{
  ...
  dt_bauhaus_slider_set_format(c->percentile_black, _("%.1f%%"));
  ...
  dt_bauhaus_slider_set_format(c->percentile_grey, _("%.1f%%"));
  ...
  dt_bauhaus_slider_set_format(c->percentile_white, _("%.1f%%"));
